...
def args_config():
    parse = argparse.ArgumentParser('Seq2seq Framework')
    ...
    parse.add_argument('--weight_decay', type=float, default=1e-5, help='weight decay for Adam optimizer')
    ...
    parse.add_argument('--update_step', type=int, default=2, help='gradient accumulation and update per x steps')
    ...
    parse.add_argument('--embed_dim', type=int, default=200, help='feature size of embedding')
    ...
    parse.add_argument('--kernel_size', type=int, default=3, help='feature size of kernel size of convolutional layer')
    parse.add_argument('--nb_layers', type=int, default=5, help='number of common layers')
    ...
    parse.add_argument('--dropout', type=float, default=0.3, help='dropout ratio')
